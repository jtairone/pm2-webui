    ...
    apps.forEach(app => {
      ...
      if (footerElement) {
        footerElement.innerHTML = app.status === 'online' ?
          `
          <button class="btn btn-sm btn-green mt-1" aria-label="Button" onclick="pm2AppAction('${app.name}', 'reload')">
          ...
          <button class="btn btn-sm btn-cyan mt-1" aria-label="Button" onclick="pm2AppAction('${app.name}', 'restart')">
          ...
          <button class="btn btn-sm btn-secondary mt-1" aria-label="Button" onclick="pm2AppAction('${app.name}', 'stop')">
           ...
           <button class="btn btn-sm btn-danger mt-1" aria-label="Button" onclick="pm2AppAction('${app.name}', 'delete')">
            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-http-delete"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 8v8h2a2 2 0 0 0 2 -2v-4a2 2 0 0 0 -2 -2z" /><path d="M14 8h-4v8h4" /><path d="M10 12h2.5" /><path d="M17 8v8h4" /></svg>
            Delete
          </button>
          ` :
          `
